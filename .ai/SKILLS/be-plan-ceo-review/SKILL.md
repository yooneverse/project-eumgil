---
name: be-plan-ceo-review
description: Run plan-ceo-review for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `plan-ceo-review` workflow in the BE lane: challenge product scope and wedge for this lane before implementation.
...
- When the user invokes `/be-plan-ceo-review`.
...
3. Read `.ai/SKILLS/plan-ceo-review/SKILL.md` and apply its procedure inside the BE lane boundary.
...
- BE-scoped result for `plan-ceo-review`
