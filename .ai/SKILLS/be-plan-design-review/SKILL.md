---
name: be-plan-design-review
description: Run plan-design-review for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---

# be-plan-design-review

## purpose

Run the `plan-design-review` workflow in the BE lane: review states, hierarchy, accessibility, and UX contracts for this lane.
...
- When the user invokes `/be-plan-design-review`.
...
3. Read `.ai/SKILLS/plan-design-review/SKILL.md` and apply its procedure inside the BE lane boundary.
...
- BE-scoped result for `plan-design-review`
