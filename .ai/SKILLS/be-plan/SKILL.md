---
name: be-plan
description: Run plan for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `plan` workflow in the BE lane: produce an executable lane-specific plan with checklist, source docs, validation, and handoff notes.
...
3. Read `.ai/SKILLS/plan/SKILL.md` and apply its procedure inside the BE lane boundary.
