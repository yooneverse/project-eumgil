---
name: be-qa
description: Run qa for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `qa` workflow in the BE lane: validate lane-specific real user or API flows.
...
3. Read `.ai/SKILLS/qa/SKILL.md` and apply its procedure inside the BE lane boundary.
