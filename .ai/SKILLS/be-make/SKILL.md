---
name: be-make
description: Run make for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `make` workflow in the BE lane: frame the problem, user, scope, and non-goals before planning.
...
3. Read `.ai/SKILLS/make/SKILL.md` and apply its procedure inside the BE lane boundary.
