---
name: fe-review
description: Run review for frontend work only. Use the FE lane source of truth, update FE docs, and record BE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `review` workflow in the FE lane: review lane-specific changes against code, docs, and risk contracts.

Base skill intent: Review changes for correctness, maintainability, edge cases, missing tests, and production risk before the code moves forward.

## when to use

- When the user invokes `/fe-review`.
...
- `.ai/LANES.md`
- `.ai/DOCS.md`
- `.ai/SKILLS/review/SKILL.md` for the base stage workflow
...
3. Read `.ai/SKILLS/review/SKILL.md` and apply its procedure inside the FE lane boundary.
...
- Hand off to the unprefixed `review` skill when the work is intentionally cross-functional.
