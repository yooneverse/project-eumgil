---
name: be-review
description: Run review for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `review` workflow in the BE lane: review lane-specific changes against code, docs, and risk contracts.
...
- When the user invokes `/be-review`.
...
3. Read `.ai/SKILLS/review/SKILL.md` and apply its procedure inside the BE lane boundary.
