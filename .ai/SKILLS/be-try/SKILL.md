---
name: be-try
description: Run try for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `try` workflow in the BE lane: close the lane-specific sprint loop and capture process improvements.
...
3. Read `.ai/SKILLS/try/SKILL.md` and apply its procedure inside the BE lane boundary.
