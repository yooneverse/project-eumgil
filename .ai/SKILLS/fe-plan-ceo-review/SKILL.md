---
name: fe-plan-ceo-review
description: Run plan-ceo-review for frontend work only. Use the FE lane source of truth, update FE docs, and record BE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `plan-ceo-review` workflow in the FE lane: challenge product scope and wedge for this lane before implementation.

Base skill intent: Challenge scope, sharpen the product wedge, and decide whether the team is building too little, too much, or the wrong thing.

## when to use

- When the user invokes `/fe-plan-ceo-review`.
...
- `.ai/LANES.md`
- `.ai/DOCS.md`
- `.ai/SKILLS/plan-ceo-review/SKILL.md` for the base stage workflow
...
3. Read `.ai/SKILLS/plan-ceo-review/SKILL.md` and apply its procedure inside the FE lane boundary.
...
- FE-scoped result for `plan-ceo-review`
...
- Hand off to the unprefixed `plan-ceo-review` skill when the work is intentionally cross-functional.
