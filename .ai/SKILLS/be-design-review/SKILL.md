---
name: be-design-review
description: Run design-review for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `design-review` workflow in the BE lane: audit delivered UI, interaction, or API-facing experience for this lane.

Base skill intent: Review delivered UI against the intended wedge, interaction states, hierarchy, and product taste, then record design debt or risk.

## when to use

- When the user invokes `/be-design-review`.
...
- `.ai/LANES.md`
- `.ai/DOCS.md`
- `.ai/SKILLS/design-review/SKILL.md` for the base stage workflow
...
3. Read `.ai/SKILLS/design-review/SKILL.md` and apply its procedure inside the BE lane boundary.
...
- BE-scoped result for `design-review`
...
- Hand off to the unprefixed `design-review` skill when the work is intentionally cross-functional.
