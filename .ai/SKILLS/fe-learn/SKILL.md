---
name: fe-learn
description: Run learn for frontend work only. Use the FE lane source of truth, update FE docs, and record BE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `learn` workflow in the FE lane: turn lane-specific repeated failures into durable memory, evals, skills, or ADRs.

Base skill intent: Turn recurring patterns, failures, and team preferences into durable repository memory, evaluation rules, skill upgrades, or ADR follow-ups.

## when to use

- When the user invokes `/fe-learn`.
...
- `.ai/LANES.md`
- `.ai/DOCS.md`
- `.ai/SKILLS/learn/SKILL.md` for the base stage workflow
...
3. Read `.ai/SKILLS/learn/SKILL.md` and apply its procedure inside the FE lane boundary.
...
- Hand off to the unprefixed `learn` skill when the work is intentionally cross-functional.
