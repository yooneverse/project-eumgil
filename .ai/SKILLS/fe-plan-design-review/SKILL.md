---
name: fe-plan-design-review
description: Run plan-design-review for frontend work only. Use the FE lane source of truth, update FE docs, and record BE dependencies as cross-lane handoff instead of mixing scope.
---

# fe-plan-design-review

## purpose

Run the `plan-design-review` workflow in the FE lane: review states, hierarchy, accessibility, and UX contracts for this lane.

Base skill intent: Force interaction states, information hierarchy, and anti-generic UI thinking into the plan before implementation begins.

## when to use

- When the user invokes `/fe-plan-design-review`.
...
- `.ai/LANES.md`
- `.ai/DOCS.md`
- `.ai/SKILLS/plan-design-review/SKILL.md` for the base stage workflow
...
3. Read `.ai/SKILLS/plan-design-review/SKILL.md` and apply its procedure inside the FE lane boundary.
...
- FE-scoped result for `plan-design-review`
...
- Hand off to the unprefixed `plan-design-review` skill when the work is intentionally cross-functional.
