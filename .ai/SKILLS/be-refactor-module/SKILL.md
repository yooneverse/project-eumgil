---
name: be-refactor-module
description: Run refactor-module for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `refactor-module` workflow in the BE lane: improve lane-specific structure while preserving behavior.
...
- When the user invokes `/be-refactor-module`.
...
- BE-scoped result for `refactor-module`
