---
name: be-learn
description: Run learn for backend work only. Use the BE lane source of truth, update BE docs, and record FE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `learn` workflow in the BE lane: turn lane-specific repeated failures into durable memory, evals, skills, or ADRs.
...
- When the user invokes `/be-learn`.
...
3. Read `.ai/SKILLS/learn/SKILL.md` and apply its procedure inside the BE lane boundary.
