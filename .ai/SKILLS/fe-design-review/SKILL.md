...
description: Run design-review for frontend work only. Use the FE lane source of truth, update FE docs, and record BE dependencies as cross-lane handoff instead of mixing scope.
---
...
Run the `design-review` workflow in the FE lane: audit delivered UI, interaction, or API-facing experience for this lane.
...
- When the user invokes `/fe-design-review`.
...
3. Read `.ai/SKILLS/design-review/SKILL.md` and apply its procedure inside the FE lane boundary.
...
- FE-scoped result for `design-review`
